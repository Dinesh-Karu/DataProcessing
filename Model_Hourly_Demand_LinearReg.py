...
df['Hr_Cat'] = df['Hour'].apply(get_hour_category)

# One-hot encode categorical variables
categorical_vars = ['Month_No','Season','Iso_Weekday','Hour','Sun_Flag','Hr_Cat']#
...
hr_cat_cols = [col for col in df_encoded.columns if col.startswith('Hr_Cat_')]
...
base_features = ['Avg_temperature']#,'Sun_Light','Is_workday'

X = df_encoded[base_features + month_cols + weekday_cols + hour_cols + sun_flag_cols]#hr_cat_cols + season_cols
